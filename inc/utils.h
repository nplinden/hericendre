 ...
 * 
 * This function removes all leading and trailing whitespace characters including
 ...
 * 
 * This template function safely accesses a value in a map by key. If the key exists,
 * it returns the associated value. If the key is not found, it returns the provided
 ...
 * @return V The value associated with the key, or the default value if key not found
 */
