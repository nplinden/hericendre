...
public:
 ...
 /**
  * @brief Collection of all neutron-induced reactions in the chain.
  *
  * Each NReaction object represents a neutron reaction (n,gamma), (n,2n), etc.
  * with cross sections and target/product nuclide information.
  */
 std::vector<NReactionPtr> reactions_;

 /**
  * @brief Collection of all fission reactions and their yield distributions.
  *
  * Each Fission object contains fission product yields for a specific
  * fissionable nuclide, organized by fission product mass and charge.
  */
