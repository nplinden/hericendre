...
Eigen::VectorXd Solver::run(const Chain& chain, std::map<std::string, double> ccMap, double dt){
...
Eigen::VectorXd Solver::run(const Chain& chain, Eigen::VectorXd ccVector, double dt){
